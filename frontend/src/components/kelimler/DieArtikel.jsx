...
const DieArtikel = ({ initialArticle = "die" }) => {
  ...
  return (
    <div className="flex flex-col items-center p-5 bg-gray-100">
      <h1 className="text-2xl font-bold text-gray-700 mb-5">Die Artikelli Kelime Ekle</h1>
      <Form
        form={form}
        layout="vertical"
        onFinish={onFinish}
