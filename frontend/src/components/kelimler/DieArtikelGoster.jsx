...
const DieArtikelGoster = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter and sort words specific to "die" artikel
        const filteredData = data
          .filter(kelime => kelime.correctArticle === "die")
          .sort((a, b) => {
  ...
  return (
    <div className="flex flex-col items-center p-5 bg-gray-100">
      <h1 className="text-2xl font-bold text-gray-700 mb-5">Die Artikelli Kelimeler</h1>
...
export default DieArtikelGoster;
